	...
	**/
	...
	function updateGrid():Void
	{
		...
		for (i in sectionInfo)
		{
			...
			note.updateHitbox();
			note.pixel = daNoteInfo > 7 && daNoteInfo < 16;
			note.harmful = daNoteInfo > 15;
	...
	private function addNote(?n:Note):Void
	{
		...
		// lol sorry coder for tricky, but idk how it works and i really
		// need this code to see why pixel notes don't work
		// edit: the issue was in playstate lol
		var noteData = Math.floor(FlxG.mouse.x / GRID_SIZE) + (/*FlxG.keys.pressed.ALT && !FlxG.keys.pressed.CONTROL ? 16 : */FlxG.keys.pressed.CONTROL/* && FlxG.keys.pressed.ALT*/ ? 8 : 0);
		var noteSus = 0;
