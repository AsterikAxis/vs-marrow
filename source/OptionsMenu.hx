...
class OptionsMenu extends MusicBeatState
{
	...
	var options:Array<OptionCategory> = [
		...
		new OptionCategory("Funny Stuff", [
			new Fullscreen("Makes the game go into fullscreen mode."),
			// new Splash('Whether or not to play the HaxeFlixel introduction when opening the game.'),
			// new FileSelect('Whether to open the file select screen when opening the game'),
			new ShowCredits('Whether to show the credits when you beat the game or not.'),
			new HealthPlus('See the results in-game.'),
			new SkipIntro("Skips the countdown for every song."),
			new SkipDialogue("This option, when turned on, makes us sad and skips the dialogue for story mode.")
		])
	];
