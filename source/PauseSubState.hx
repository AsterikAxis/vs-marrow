...
class PauseSubState extends MusicBeatSubstate
{
	...
	var menuItems:Array<String> = ['Resume', 'Restart Song', 'Exit Song'];
	...
	public function new(x:Float, y:Float)
	{
		...
		pauseMusic = new FlxSound().loadEmbedded(Paths.music(FlxG.random.bool(10) ? 'titleTest' : 'normal_pills'), true, true);
		pauseMusic.volume = 0;
		...
		}else if (downP || FlxG.mouse.wheel == -1)
		{
			...
			else if (leftP)
			{
				...
				if(!offsetChanged)
				{
					...
					menuItems = ['Restart Song', 'Exit Song'];
